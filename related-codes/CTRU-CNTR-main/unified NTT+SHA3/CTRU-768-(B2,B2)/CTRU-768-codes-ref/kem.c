                      ...
                      unsigned char *sk)
{
  ...
  do
  {
    ...
    crypto_hash_shake256(coins, CTRU_COIN_BYTES, coins, CTRU_SEEDBYTES);
...
{
  unsigned int i;
  unsigned char buf[CTRU_SHAREDKEYBYTES + CTRU_COIN_BYTES], m[CTRU_PREFIXHASHBYTES + CTRU_MSGBYTES];
  ...
  crypto_hash_shake256(buf + CTRU_SHAREDKEYBYTES, CTRU_COIN_BYTES, buf + CTRU_SHAREDKEYBYTES, 32);
...
{
  unsigned int i;
  unsigned char buf[CTRU_SHAREDKEYBYTES + CTRU_COIN_BYTES], buf2[CTRU_SHAREDKEYBYTES * 2], m[CTRU_PREFIXHASHBYTES + CTRU_MSGBYTES];
