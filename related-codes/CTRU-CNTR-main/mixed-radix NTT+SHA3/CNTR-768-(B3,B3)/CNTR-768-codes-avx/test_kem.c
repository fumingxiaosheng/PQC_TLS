...
void test_kem()
{
  ...
  unsigned char pk[CTRU_KEM_PUBLICKEYBYTES] __attribute__((aligned(32))), sk[CTRU_KEM_SECRETKEYBYTES] __attribute__((aligned(32)));
  unsigned char ct[CTRU_KEM_CIPHERTEXTBYTES] __attribute__((aligned(32)));
